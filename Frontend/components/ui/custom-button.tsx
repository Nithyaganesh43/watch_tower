...
export function CustomButton({ children, onClick, disabled = false, className = "" }: CustomButtonProps) {
  return (
    <div className={`btn-container ${disabled ? "disabled" : ""} ${className}`}>
      <button className="button" onClick={onClick} disabled={disabled}>
        <span>{children}</span>
        <svg viewBox="0 0 48 48" height="1.2em" width="1.2em" className="svg" xmlns="http://www.w3.org/2000/svg">
          <path
